...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		Category category1 = new Category(1,"Yazýlým Geliþtirme");
		Instructor instructor1 = new Instructor(1,"Engin","Demiroð",35);
		isExist.add(course1, category1);
		baseManager.add(course1, category1, instructor1);
		
		Course course2 = new Course(1,"C#",60000);
		Category category2 = new Category(1,"Yazýlým Geliþtirme");
		Instructor instructor2 = new Instructor(1,"Engin","Demiroð",35);
		isExist.add(course1, category1);
		baseManager.add(course1, category1, instructor1);
